      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildDifficultyOption(context, "Easy (Human-like)", 3, Colors.green),
            _buildDifficultyOption(context, "Medium (Intelligent)", 4, Colors.orange),
            _buildDifficultyOption(context, "Advanced (Grandmaster)", 5, Colors.red),
          ],
        ),
      ),
    );
